<?php
/* Smarty version 3.1.30, created on 2018-07-20 21:40:39
  from "C:\xampp\htdocs\iam_salle\view\classe\edit.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5b523ab71825a4_07143520',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b9165c2c480fb8c10493a18482b121b51f1fcf6c' => 
    array (
      0 => 'C:\\xampp\\htdocs\\iam_salle\\view\\classe\\edit.html',
      1 => 1532114658,
      2 => 'file',
    ),
  ),
...
function content_5b523ab71825a4_07143520 (Smarty_Internal_Template $_smarty_tpl) {
?>
<html>
<head>
...
<div class="col-md-8 col-xs-12 col-md-offset-2" style="margin-top:50px;">
    <div class="panel panel-info">
        <div class="panel-heading">Formulaire d'edition de Classes</div>
...
?>
                <div class="form-group col-md-6">
                    <input class="form-control" type="HIDDEN" name="id" id="idclasse" value="<?php echo $_smarty_tpl->tpl_vars['test']->value['idclasse'];?>
"/>
                    <label class="control-label">Nom De la Classe</label>
                    <input class="form-control" type="text" name="nc" id="nc" value="<?php echo $_smarty_tpl->tpl_vars['test']->value['nomclasse'];?>
" required/>
                </div>
                <div class="form-group col-md-12">
                    <label class="control-label">Effectif de la classe</label>
                    <input class="form-control" type="text" name="ef" id="ef" value="<?php echo $_smarty_tpl->tpl_vars['test']->value['effectif'];?>
" required/>
                </div>
                <div class="form-group col-md-12">
